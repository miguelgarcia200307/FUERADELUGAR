...
console.log(JSON.stringify({initial,categoryBehavior,customization,preview,viewports,normalizedOff,createFlow,publicData,emptyPublic,validPublicCustomization,runtimeErrors,screenshotPath},null,2));
socket.close();
